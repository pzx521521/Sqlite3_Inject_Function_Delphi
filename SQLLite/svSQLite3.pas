...
type
  ...
  sqlite3_vfs = record
    ...
    zName: PAnsiChar;
    pAppData: Pointer;
    xOpen: function(Asqlite3_vfs: Psqlite3_vfs; zName: PAnsiChar; sqlite3_file: Pointer; flags: Integer; pOutFlags: PInteger): Integer; cdecl;
    xDelete: function(Asqlite3_vfs: Psqlite3_vfs; zName: PAnsiChar; syncDir: Integer): Integer; cdecl;
    xAccess: function(Asqlite3_vfs: Psqlite3_vfs; zName: PAnsiChar; flags: Integer; pResOut: PInteger): Integer; cdecl;
    xFullPathname: function(Asqlite3_vfs: Psqlite3_vfs; zName: PAnsiChar; nOut: Integer; zOut: PAnsiChar): Integer; cdecl;
    xDlOpen: function(Asqlite3_vfs: Psqlite3_vfs; zFilename: PAnsiChar): Pointer; cdecl;
    xDlError: function(Asqlite3_vfs: Psqlite3_vfs; nByte: Integer; zErrMsg: PAnsiChar): Pointer; cdecl;
    xDlSym: function(Asqlite3_vfs: Psqlite3_vfs; pAux: Pointer; zSymbol: PAnsiChar): Pointer; cdecl;
    xDlClose: function(Asqlite3_vfs: Psqlite3_vfs; pAux: Pointer): Pointer; cdecl;
    xRandomness: function(Asqlite3_vfs: Psqlite3_vfs; nByte: Integer; zOut: PAnsiChar): Integer; cdecl;
    xSleep: function(Asqlite3_vfs: Psqlite3_vfs; microseconds: Integer): Integer; cdecl;
    xCurrentTime: function(Asqlite3_vfs: Psqlite3_vfs; pDou: PDouble): Integer; cdecl;
    xGetLastError: function(Asqlite3_vfs: Psqlite3_vfs; zLastError: PAnsiChar): Integer; cdecl;

//    xCurrentTimeInt64: function(): Integer; cdecl;
//    xSetSystemCall: function(): Integer; cdecl;
  end;
...
var
  ...
  sqlite3_vfs_register: function(Asqlite3_vfs: Psqlite3_vfs; makeDflt: Integer): Integer; cdecl;
  sqlite3_vfs_unregister: function(Asqlite3_vfs: Psqlite3_vfs): Integer; cdecl;
...
begin
  ...
  begin
    ...
    begin
      sqlite3_vfs_find := LoadProc('sqlite3_vfs_find');
      sqlite3_vfs_register := LoadProc('sqlite3_vfs_register');
      sqlite3_vfs_unregister := LoadProc('sqlite3_vfs_unregister');
