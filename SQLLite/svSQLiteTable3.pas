...
begin
  ...
  try
    ...
    // 2016-06-16 Wenxh 文件打开超过两次会报错的问题
//    Fsqlite3_vfs := sqlite3_vfs_find(NIL);
//    if Fsqlite3_vfs <> nil then
//    begin
//      Fsqlite3_vfs.mxPathname := 1000;
//      sqlite3_vfs_register(Fsqlite3_vfs, 0);
//    end;
...
// 2016-06-16 Wenxh 文件打开超过两次会报错的问题
//  if Fsqlite3_vfs <> nil then
//    sqlite3_vfs_unregister(Fsqlite3_vfs);
  if Assigned(fDB) then
    SQLite3_Close(fDB);
  FConnected := False;
